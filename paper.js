class paper
{
	constructor(x,y)
	{
		...
		this.rightWallBody=Bodies.rectangle(this.x+this.paperWidth/2, this.y-this.paperHeight/2, this.wallThickness, this.dustbinHeight, {isStatic:true})
